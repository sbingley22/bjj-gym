...
function App() {
  return (
    <div className="min-h-screen bg-slate-800 text-white">
      ...
      <header className="bg-red-600 py-4">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <nav>
            ...
            <a href="#classes" className="mx-2 hover:underline">
              Classes
            </a>
      ...
      <main>
        ...
        >
          <div className="flex items-center justify-center h-full bg-slate-900 bg-opacity-60">
            <h2 className="text-4xl font-bold text-red-500 p-5">Train Like a Champion</h2>
          </div>
        </section>

        {/* About Section */}
        <section id="about" className="py-8 container mx-auto">
        ...
        {/* Animation */}
        <section id="moves" className="py-8 container mx-auto">
        ...
        <section id="classes" className="py-8 container mx-auto">
        ...
        <section id="contact" className="py-8 container mx-auto">
      ...
      {/* Footer */}
      <footer className="bg-red-600 py-4">
